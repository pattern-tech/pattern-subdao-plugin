...
describe('getNamedTypesFromMetadata', function () {
    it('simple', async () => {
        ...
        expect(getNamedTypesFromMetadata(json.inputs)).to.deep.equal(['uint256 number', 'address account']);
    });
    ...
    it('array', async () => {
        ...
        expect(getNamedTypesFromMetadata(json.inputs)).to.deep.equal(['address[] members']);
    });
    ...
    it('struct', async () => {
        ...
        expect(getNamedTypesFromMetadata(json.inputs)).to.deep.equal(['tuple(bool onlyListed, uint16 minApprovals)']);
    });
