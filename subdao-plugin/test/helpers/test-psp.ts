import { DAO, PluginSetupProcessor, PluginSetupProcessor__factory } from '../../typechain';
import { osxContracts } from '../../utils/helpers';
import { Operation } from './types';
import { SignerWithAddress } from '@nomiclabs/hardhat-ethers/signers';

export async function createPluginSetupProcessor(deployer: SignerWithAddress, dao: DAO): Promise<PluginSetupProcessor> {
