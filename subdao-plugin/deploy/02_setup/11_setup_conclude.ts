...
import { SubDAOPlugin__factory, SubDAOPluginSetup__factory } from '../../typechain';
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    const setup = SubDAOPluginSetup__factory.connect(setupDeployment.address, deployer);
    const implementation = SubDAOPlugin__factory.connect(await setup.implementation(), deployer);
