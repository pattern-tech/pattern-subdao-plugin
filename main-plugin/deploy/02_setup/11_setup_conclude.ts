...
import {ScalingDAO__factory, ScalingDAOSetup__factory} from '../../typechain';
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const setup = ScalingDAOSetup__factory.connect(
    setupDeployment.address,
    deployer
  );
  const implementation = ScalingDAO__factory.connect(
